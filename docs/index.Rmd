...
modern_family %>%
  ...
  title = 
  "
  <span style='color:grey25;font-size:30px'>Audiência nos episódios de
  <span style='font-family:Archivo; color:#1D1D1D;  font-size:35px'>modern
  <span style='font-family:Prata;   color:#C64E24;  font-size:35px'>family
  "
...
#    title = "Audiência (em milhões) nos episódios de Modern Family"
  ...
  title = 
  "
  <span style='color:grey25;font-size:30px'>Audiência na temporada de
  <span style='font-family:Archivo; color:#1D1D1D;  font-size:35px'>modern
  <span style='font-family:Prata;   color:#C64E24;  font-size:35px'>family
  "
